...
> **Current phase:** P5 feature build-out — **Gifts (XP-funded, v1)** ✅ shipped end-to-end (backend + mobile + realtime/push), Challenges mobile screen shipped. P4 profile & monetization surface (G1–G5) code-complete; all migrations applied; **G2 (Twilio) + G3 (Stripe, test mode) creds landed 2026-06-05** (pending live verify), G4 social deferred. Apple Sign-In (A3) removed from scope 2026-06-05. P2 7-day synthetic gate clears 2026-06-06.
> **Owner:** [your name]
>
...
|--------|---------------|------------------------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------------------------------|
| A3     | Auth          | ~~Apple Sign-In (`POST /auth/oauth/apple`)~~ — **removed from scope 2026-06-05**                           | —        | ❌ removed (code, deps, migration 0009 reverted by 0019). See App Store risk re: shipping Google without Apple on iOS. |
