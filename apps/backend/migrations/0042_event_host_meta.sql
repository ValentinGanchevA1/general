-- 0042_event_host_meta.sql
-- Expose event host on discovery meta so map sheet can open chat in one tap.
-- Mirrors 0041 listing seller pattern. JOIN users for display name (chat header).
