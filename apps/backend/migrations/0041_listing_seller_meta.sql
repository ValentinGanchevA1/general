-- 0041_listing_seller_meta.sql
-- Expose seller on discovery listing meta so map sheet can open chat in one tap.
-- JOIN users for display name (chat header). Soft-deleted sellers still leave
-- the listing active until withdrawn — sellerId remains for permission checks.
