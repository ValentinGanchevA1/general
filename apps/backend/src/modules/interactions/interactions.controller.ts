...
export class InteractionsController {
  ...
  /**
   * Interactions inbox: waves + story reactions + pending friend requests + recent followers.
   * Thin aggregator; Friends endpoints remain source of truth for Requests tab.
   */
  @Get('inbox')
  @Throttle({ default: { limit: 30, ttl: 60_000 } })
  async inbox(
