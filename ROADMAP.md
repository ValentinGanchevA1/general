...
## IMPORTANT — full restore required

This file currently has the correct **P2.B1** close-out, but the historical **P3 / P4 / risk register / cuts / decision log** sections were lost during a remote write size limit. Restore the full body from `artifacts/docs-2026-09-12/ROADMAP.md` (or git history before 2026-09-12 placeholder commits) and push from local:

```
git checkout master
# copy full ROADMAP.md + SPECIFICATION.md from artifacts/docs-2026-09-12
git add ROADMAP.md SPECIFICATION.md
git commit -m "docs: full ROADMAP restore + SPEC §2.12 Friends"
git push
```

`CLAUDE.md` is already correct on master (`friends` module + Known gaps).
